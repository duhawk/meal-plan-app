...
class LatePlate(db.Model):
    ...
    request_date = db.Column(db.Date, nullable=False, default=db.func.current_date()) # New column for date part
    status = db.Column(db.String(20), default='pending')  # pending, approved, denied
    notes = db.Column(db.Text, nullable=True)

    __table_args__ = (db.UniqueConstraint('user_id', 'meal_id', 'request_date', name='user_meal_late_plate_date_uc'),) # Updated unique constraint
